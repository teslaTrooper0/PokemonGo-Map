...
from . import RpcEnum_pb2 as RpcEnum__pb2
...
_APPLIEDITEM.fields_by_name['item_type'].enum_type = RpcEnum__pb2._ITEMTYPE
_APPLIEDITEM.fields_by_name['item_type_category'].enum_type = RpcEnum__pb2._ITEMTYPECATEGORY
